...
* `compdocss`: **Comp**anion to **Do**ing **C**omputational **S**ocial **S**cience. A Python package with code and data accompanying *Doing Computational Social Science*, currently under contract with Sage. Designed and developed by John McLevey. Website and documentation: Coming soon...
